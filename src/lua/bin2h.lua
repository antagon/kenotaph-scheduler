local description = [=[
Usage: lua bin2h.lua [+]filename [status]
...
local dump do
	...
	function dump(str)
		return (str:gsub(".", numtab):gsub(("."):rep(60), "%0\n"))
	end
end
...
]], filename:gsub ("[^a-zA-Z0-9]", "_"):upper (), filename:gsub ("[^a-zA-Z0-9]", "_"):upper (), filename:gsub ("[^a-zA-Z0-9]", "_"), dump(content)))
